<template>
    ...
    >
        ...
        <el-card class="box-card titleCard">
            <p style="text-align:center;font-size: 25px;font-family:'KaiTi';font-weight: bold;">{{spot.spotName}}</p>    
        </el-card>
        ...
        <el-card class="box-card commentCard">
            <el-input placeholder="请发布有价值的评论，博客评论不欢迎灌水，良好的社区氛围需大家一起维护。" v-model = "contentCopy">
                <el-button slot="append" icon="el-icon-s-promotion" @click = "commentspot">发送</el-button>
            </el-input>
...
<script>
import {getSpotByIdAPI,ReplyAPI,deleteReplyAPI,getCommentByBelongIdAPI} from '@/request/sys_api'
...
export default{
    ...
    methods:{
        getData(){
            ...
            getSpotByIdAPI(id).then(function(res){
                // console.log(res)
                this.spot = res.data.data.spotById;
            }.bind(this))
            getCommentByBelongIdAPI(id,1).then(function(res){
                console.log(res)
